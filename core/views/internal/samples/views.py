        ...
        if action == "add_sample":
            ...
            try:
                ...
                with transaction.atomic():
                    ...
                    # ARQUIVOS COM CATEGORIA E DESCRIÇÃO (CREATE)
                    ...
                    for sample in created_samples:
                        ...
                        # Grava cada arquivo ligando com a sua respectiva categoria e descrição
...
def sample_edit_view(request, sample_id):
    ...
    if request.method == "POST":
        ...
        # ATUALIZADO: Adicionado request.FILES para ler os arquivos na edição
        ...
        if form.is_valid():
            ...
            # NOVO: SALVAR ARQUIVOS ADICIONADOS NA EDIÇÃO COM CATEGORIA
    ...
    # NOVO: Busca os arquivos que já estão salvos nesta amostra
    ...
    ctx.update({
        ...
        'sample_files': sample_files # Passa para o HTML exibir
